...
This page explains how Puma apps are built, and how to add support for a new app or new functionality. For the contribution process (issues, pull requests, new app versions), see [CONTRIBUTING](../CONTRIBUTING.md).
